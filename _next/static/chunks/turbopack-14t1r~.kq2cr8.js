(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, {
    otherChunks: ["static/chunks/0ursk~c~2p0vl.js", "static/chunks/03vcybz4ldxd4.js", "static/chunks/10u3y4bw1ayzs.js"],
...
( () => {
    ...
    var o, l = ((o = l || {})[o.Runtime = 0] = "Runtime",
    o[o.Parent = 1] = "Parent",
    o[o.Update = 2] = "Update",
    o);
    let i = new WeakMap;
    ...
    u.j = function(e, t) {
        var r, n;
        let o, l, s;
        null != t ? l = (o = p(this.c, t)).exports : (o = this.m,
        l = this.e);
        let u = (r = o,
        n = l,
        (s = i.get(r)) || (i.set(r, s = []),
    ...
    u.a = function(e, t) {
        let r = this.m
          ...
          , o = new Set
          , {resolve: l, reject: i, promise: s} = k()
          , u = Object.assign(s, {
            [v]: r.exports,
            [j]: e => {
                n && e(n),
    ...
    S.b = function(e, t, o, l) {
        ...
        let u = new URL(N(t),location.origin)
          , a = JSON.stringify(s);
        return i ? u.searchParams.set("params", a) : u.hash = "#params=" + encodeURIComponent(a),
        new e(u,l ? {
            ...l,
            type: void 0
        } : void 0)
    ...
    e = {
        async registerChunk(e, r) {
            ...
            if (D("string" == typeof e ? N(e) : e.src).resolve(),
            null != r) {
                for (let e of r.otherChunks)
                    D(N("string" == typeof e ? e : e.path));
                if (await Promise.all(r.otherChunks.map(e => T(l.Runtime, n, e))),
...
;(function() {
    ...
    s.setAttribute("data-deployment-id", "dpl_5zn4BsDDiFMg4cnDoh7Xj3JVYgvh");
