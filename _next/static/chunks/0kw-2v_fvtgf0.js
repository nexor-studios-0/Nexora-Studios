(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 46932, 76959, 83411, 65566, 60830, 87022, 30551, 25791, 86427, 31178, 37806, 21476, 47414, 74008, 83920, 44230, 15923, 49652, 61327, 64978, 72846, t => {
    "use strict";
    let e, i, n, s = ["transformPerspective", "x", "y", "z", "translateX", "translateY", "translateZ", "scale", "scaleX", "scaleY", "rotate", "rotateX", "rotateY", "rotateZ", "skew", "skewX", "skewY"], r = new Set(s), o = (t, e, i) => i > e ? e : i < t ? t : i;
    t.s(["clamp", 0, o], 76959);
    let a = {
      ...
      , p = (t, e) => i => !!("string" == typeof i && c.test(i) && i.startsWith(t) || e && null != i && Object.prototype.hasOwnProperty.call(i, e))
      , m = (t, e, i) => n => {
        if ("string" != typeof n)
            return n;
      ...
      , f = {
        ...a,
        transform: t => Math.round(o(0, 255, t))
    }
      , g = {
        test: p("rgb", "red"),
        parse: m("red", "green", "blue"),
        transform: ({red: t, green: e, blue: i, alpha: n=1}) => "rgba(" + f.transform(t) + ", " + f.transform(e) + ", " + f.transform(i) + ", " + u(l.transform(n)) + ")"
    }
      , y = {
        test: p("#"),
        parse: function(t) {
      ...
      , E = {
        ...
        transform: ({hue: t, saturation: e, lightness: i, alpha: n=1}) => "hsla(" + Math.round(t) + ", " + w.transform(u(e)) + ", " + w.transform(u(i)) + ", " + u(l.transform(n)) + ")"
    }
      , A = {
        test: t => g.test(t) || y.test(t) || E.test(t),
        parse: t => g.test(t) ? g.parse(t) : E.test(t) ? E.parse(t) : y.parse(t),
        transform: t => "string" == typeof t ? t : t.hasOwnProperty("red") ? g.transform(t) : E.transform(t),
        getAnimatableNone: t => {
            let e = A.parse(t);
            return e.alpha = 0,
            A.transform(e)
      ...
      , M = /(?:#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\))/giu
      , V = "number"
      , C = "color"
      , k = /var\s*\(\s*--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)|#[\da-f]{3,8}|(?:rgb|hsl)a?\((?:-?[\d.]+%?[,\s]+){2}-?[\d.]+%?\s*(?:[,/]\s*)?(?:\b\d+(?:\.\d+)?|\.\d+)?%?\)|-?(?:\d+(?:\.\d+)?|\.\d+)/giu;
    function D(t) {
        let e = t.toString()
          , i = []
          , n = {
          ...
          , s = []
          , r = 0
          , o = e.replace(k, t => (A.test(t) ? (n.color.push(r),
        s.push(C),
        i.push(A.parse(t))) : t.startsWith("var(") ? (n.var.push(r),
        s.push("var"),
    ...
    function R({split: t, types: e}) {
        ...
        return n => {
            ...
            for (let r = 0; r < i; r++)
                ...
                void 0 !== n[r]) {
                    let t = e[r];
                    t === V ? s += u(n[r]) : t === C ? s += A.transform(n[r]) : s += n[r]
                }
            return s
        }
    }
    let L = {
        test: function(t) {
            return isNaN(t) && "string" == typeof t && (t.match(d)?.length || 0) + (t.match(M)?.length || 0) > 0
        },
        parse: function(t) {
            return D(t).values
        },
        ...
        getAnimatableNone: function(t) {
            let e = D(t);
            return R(e)(e.values.map( (t, i) => ( (t, e) => "number" == typeof t ? e?.trim().endsWith("/") ? t : 0 : "number" == typeof t ? 0 : A.test(t) ? A.getAnimatableNone(t) : t)(t, e.split[i])))
        }
    }
    ...
    let F = /\b([a-z-]*)\(.*?\)/gu
      ...
      , I = {
        ...
        getAnimatableNone: t => {
            let e = L.parse(t);
            return L.createTransformer(t)(e.map(t => "number" == typeof t ? 0 : "object" == typeof t ? {
                ...t,
                alpha: 1
            } : t))
        }
      ...
      , K = t => !!(t && t.getVelocity);
    t.s(["isMotionValue", 0, K], 83411);
    let G = new Set(["width", "height", "top", "left", "right", "bottom", ...s])
      , q = t => e => e.test(t)
      , _ = [a, T, w, x, S, b, {
        test: t => "auto" === t,
        parse: t => t
    ...
    ;
    Q.default,
    t.s(["invariant", 0, te, "warning", 0, tt], 65566);
    let ti = t => e => "string" == typeof e && e.startsWith(t)
      , tn = ti("--")
      , ts = ti("var(--")
      , tr = t => !!ts(t) && to.test(t.split("/*")[0].trim())
      , to = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
    function ta(t) {
        return "string" == typeof t && t.split("/*")[0].includes("var(--")
    }
    let tl = /^var\(--(?:([\w-]+)|([\w-]+), ?([a-zA-Z\d ()%#.,-]+))\)/u
      , th = t => 180 * t / Math.PI
      , tu = t => tc(th(Math.atan2(t[1], t[0])))
      , td = {
        x: 4,
        y: 5,
        translateX: 4,
    ...
    t)
      ...
      , tm = t => Math.sqrt(t[4] * t[4] + t[5] * t[5])
      , tf = {
        x: 12,
        y: 13,
        z: 14,
        ...
        scaleY: tm,
        scale: t => (tp(t) + tm(t)) / 2,
        rotateX: t => tc(th(Math.atan2(t[6], t[5]))),
        rotateY: t => tc(th(Math.atan2(-t[2], t[0]))),
        rotateZ: tu,
        rotate: tu,
    ...
    t.s(["noop", 0, tS], 60830);
    let tP = {}
      , tE = ["setup", "read", "resolveKeyframes", "preUpdate", "update", "preRender", "render", "postRender"];
    function tA(t, e) {
        let i = !1
          , n = !0
          , s = {
          ...
          , r = () => i = !0
          , o = tE.reduce( (t, i) => (t[i] = function(t, e) {
            let i = new Set
              , n = new Set
              , s = !1
              , r = !1
        ...
        t), {})
          , {setup: a, read: l, resolveKeyframes: h, preUpdate: u, update: d, preRender: c, render: p, postRender: m} = o
          , f = () => {
            let r = tP.useManualTiming
              , o = r ? s.timestamp : performance.now();
            i = !1,
            r || (s.delta = n ? 1e3 / 60 : Math.max(Math.min(o - s.timestamp, 40), 1)),
            s.timestamp = o,
            s.isProcessing = !0,
            a.process(s),
            l.process(s),
    ...
    let {schedule: tM, cancel: tV, state: tC, steps: tk} = tA("u" > typeof requestAnimationFrame ? requestAnimationFrame : tS, !0);
    t.s(["cancelFrame", 0, tV, "frame", 0, tM, "frameData", 0, tC, "frameSteps", 0, tk], 87022);
    let tD = new Set
      , tR = !1
      , tL = !1
      , tB = !1;
    function tj() {
        ...
        tL = !1,
        tR = !1,
        tD.forEach(t => t.complete(tB)),
        tD.clear()
    }
    function tF() {
        tD.forEach(t => {
            t.readKeyframes(),
            t.needsMeasurement && (tL = !0)
        }
        )
    }
    class tO {
        ...
        scheduleResolve() {
            ...
            tR || (tR = !0,
            tM.read(tF),
            tM.resolveKeyframes(tj))) : (this.readKeyframes(),
            this.complete())
        }
        readKeyframes() {
        ...
        cancel() {
            "scheduled" === this.state && (tD.delete(this),
            this.state = "pending")
        }
        resume() {
    ...
    class tN extends tO {
        ...
        readKeyframes() {
            ...
            for (let i = 0; i < t.length; i++) {
                let n = t[i];
                if ("string" == typeof n && tr(n = n.trim())) {
                    let s = function t(e, i, n=1) {
                        te(n <= 4, `Max CSS variable fallback depth detected in property "${e}". This may indicate a circular fallback dependency.`, "max-css-var-depth");
                        let[s,r] = function(t) {
                            let e = tl.exec(t);
                            if (!e)
                                return [, ];
        ...
        resolveNoneKeyframes() {
            ...
            i.length && function(t, e, i) {
                ...
                for (; s < t.length && !n; ) {
                    let e = t[s];
                    "string" == typeof e && !tU.has(e) && D(e).values.length && (n = t[s]),
                    s++
                }
                if (n && i)
                    for (let s of e)
        ...
        measureInitialState() {
            ...
            this.measuredOrigin = tb[i](t.measureViewportBox(), window.getComputedStyle(t.current)),
        ...
        measureEndState() {
            ...
            let s = i.length - 1
              , r = i[s];
            i[s] = tb[e](t.measureViewportBox(), window.getComputedStyle(t.current)),
    ...
    class tY {
        ...
        add(t) {
            return tz(this.subscriptions, t),
            () => tH(this.subscriptions, t)
        }
        notify(t, e, i) {
    ...
    let t_ = tq( () => void 0 !== window.ScrollTimeline, "scrollTimeline")
      , tZ = tq( () => void 0 !== window.ViewTimeline, "viewTimeline");
    t.s(["supportsScrollTimeline", 0, t_, "supportsViewTimeline", 0, tZ], 30551);
    let tJ = t => null !== t;
    ...
    , "linearEasing")
      ...
      , t6 = {
        ...
        circIn: t4([0, .65, .55, 1]),
        circOut: t4([.55, 0, 1, .45]),
        backIn: t4([.31, .01, .66, -.59]),
        backOut: t4([.33, 1.53, .69, .99])
    };
    function t9(t) {
    ...
    class t7 extends t0 {
        constructor(t) {
            ...
            !t)
                return;
            const {element: e, name: i, keyframes: n, pseudoElement: s, allowFlatten: r=!1, finalKeyframe: o, onComplete: a} = t;
            this.isPseudoElement = !!s,
            this.allowFlatten = r,
            this.options = t,
            te("string" != typeof t.type, 'Mini animate() doesn\'t support "type" as a string.', "mini-spring");
            const l = function({type: t, ...e}) {
                return t9(t) && t5() ? t.applyToOptions(e) : (e.duration ?? (e.duration = 300),
                e.ease ?? (e.ease = "easeOut"),
                e)
            }(t);
            this.animation = function(t, e, i, {delay: n=0, duration: s=300, repeat: r=0, repeatType: o="loop", ease: a="easeOut", times: l}={}, h) {
                let u = {
                    [e]: i
                };
                l && (u.offset = l);
                let d = function t(e, i) {
                    if (e)
                        return "function" == typeof e ? t5() ? t3(e, i) : "ease-out" : t2(e) ? t4(e) : Array.isArray(e) ? e.map(e => t(e, i) || t6.easeOut) : t6[e]
                }(a, s);
        ...
        attachTimeline({timeline: t, rangeStart: e, rangeEnd: i, observe: n}) {
            ...
            t && t_()) ? (this.animation.timeline = t,
            e && (this.animation.rangeStart = e),
            i && (this.animation.rangeEnd = i),
            tS) : n(this)
        }
    }
    let t8 = new Set(["opacity", "clipPath", "filter", "transform"])
      , {schedule: et} = tA(queueMicrotask, !1);
    function ee() {
        e = void 0
    }
    let ei = {
        now: () => (void 0 === e && ei.set(tC.isProcessing || tP.useManualTiming ? tC.timestamp : performance.now()),
        e),
        set: t => {
            e = t,
            queueMicrotask(ee)
    ...
    t.s(["velocityPerSecond", 0, en], 25791);
    let es = {
        current: void 0
    };
    class er {
        ...
        on(t, e) {
            this.events[t] || (this.events[t] = new tY);
        ...
        get() {
            return es.current && es.current.push(this),
            this.current
        }
        getPrevious() {
            return this.prev
        ...
        getVelocity() {
            ...
            return en(parseFloat(this.current) - parseFloat(this.prevFrameValue), e)
        }
        start(t) {
            return this.stop(),
            new Promise(e => {
    ...
    t.s(["collectMotionValues", 0, es, "motionValue", 0, eo], 86427);
    let ea = [..._, A, L]
      , el = new WeakMap;
    function eh(t) {
    ...
    let ed = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"]
      , ec = ["initial", ...ed];
    function ep(t) {
        return eh(t.animate) || ec.some(e => eu(t[e]))
    }
    function em(t) {
    ...
    let ew = ["AnimationStart", "AnimationComplete", "Update", "BeforeLayoutMeasure", "LayoutMeasure", "LayoutAnimationStart", "LayoutAnimationComplete"]
      , eT = {};
    class eb {
        scrapeMotionValuesFromProps(t, e, i) {
            return {}
        }
        constructor({parent: t, props: e, presenceContext: i, reducedMotionConfig: n, skipAnimations: s, blockInitialAnimation: r, visualState: o}, a={}) {
            this.current = null,
            ...
            this.isControllingVariants = ep(e),
        ...
        mount(t) {
            ...
            "never" === this.reducedMotionConfig ? this.shouldReduceMotion = !1 : "always" === this.reducedMotionConfig ? this.shouldReduceMotion = !0 : (eg.current || function() {
                if (eg.current = !0,
                ey)
            ...
            this.shouldReduceMotion = ef.current),
        ...
        bindToMotionValue(t, e) {
            ...
            e.accelerate && t8.has(t) && this.current instanceof HTMLElement) {
            ...
            let s = e.on("change", e => {
                ...
                this.props.onUpdate && tM.preRender(this.notifyUpdate),
        ...
        getValue(t, e) {
            ...
            let i = this.values.get(t);
            return void 0 === i && void 0 !== e && (i = eo(null === e ? void 0 : e, {
                owner: this
            }),
            this.addValue(t, i)),
            i
        ...
        getBaseTarget(t) {
            ...
            if ("string" == typeof i || "object" == typeof i) {
                let n = ex(this.props, i, this.presenceContext?.custom);
                n && (e = n[t])
            }
            if (i && void 0 !== e)
                return e;
            let n = this.getBaseTargetFromProps(this.props, t);
            return void 0 === n || K(n) ? void 0 !== this.initialValues[t] && void 0 === e ? void 0 : this.baseTarget[t] : n
        }
        on(t, e) {
            return this.events[t] || (this.events[t] = new tY),
            this.events[t].add(e)
        }
        notify(t, ...e) {
    ...
    let eE = (t, e) => e && "number" == typeof t ? e.transform(t) : t
      , eA = {
        x: "translateX",
        y: "translateY",
        z: "translateZ",
    ...
    function eR(t, {attrX: e, attrY: i, attrScale: n, pathLength: s, pathSpacing: r=1, pathOffset: o=0, ...a}, l, h, u) {
        if (eV(t, a, h),
        l) {
    ...
    function ej(t, {style: e, vars: i}, n, s) {
        let r, o = t.style;
        for (r in e)
            o[r] = e[r];
        for (r in s?.applyProjectionStyles(o, n),
        i)
            o.setProperty(r, i[r])
    }
    function eF(t, e) {
    ...
    function eU(t, {layout: e, layoutId: i}) {
        return r.has(t) || t.startsWith("origin") || (e || void 0 !== i) && (!!eW[t] || "opacity" === t)
    }
    function eN(t, e, i) {
        let n = t.style
          , s = e?.style
        ...
        if (!n)
            return r;
        for (let e in n)
            (K(n[e]) || s && K(s[e]) || eU(e, t) || i?.getValue(e)?.liveStyle !== void 0) && (r[e] = n[e]);
        return r
    }
    function e$(t, e, i) {
        let n = eN(t, e, i);
        for (let i in t)
            (K(t[i]) || K(e[i])) && (n[-1 !== s.indexOf(i) ? "attr" + i.charAt(0).toUpperCase() + i.substring(1) : i] = t[i]);
        return n
    }
    class ez extends eS {
        constructor() {
        ...
        renderInstance(t, e, i, n) {
            for (let i in ej(t, e, void 0, n),
            e.attrs)
                t.setAttribute(eL.has(i) ? i : eP(i), e.attrs[i])
        }
        mount(t) {
            this.isSVGTag = eB(t.tagName),
            super.mount(t)
        }
    }
    function eH({top: t, left: e, right: i, bottom: n}) {
        return {
            x: {
                min: e,
                max: i
    ...
    function eK(t) {
        return eX(t) || eG(t) || t.z || t.rotate || t.rotateX || t.rotateY || t.skewX || t.skewY
    }
    function eG(t) {
        var e, i;
    ...
    function e_(t, e=0, i=1, n, s) {
        t.min = eq(t.min, e, i, n, s),
        t.max = eq(t.max, e, i, n, s)
    }
    function eZ(t, {x: e, y: i}) {
    ...
    function e1(t, e, i) {
        let n = i ?? t;
        eQ(t.x, e0(e.x, n.x), e.scaleX, e.scale, e.originX),
        eQ(t.y, e0(e.y, n.y), e.scaleY, e.scale, e.originY)
    }
    function e2(t, e) {
    ...
    class e5 extends eS {
        constructor() {
            super(...arguments),
            this.type = "html",
            this.renderInstance = ej
        }
        readValueFromInstance(t, e) {
            if (r.has(e))
                return this.projection?.isProjecting ? tg(e) : ( (t, e) => {
    ...
    var e3 = t.i(71645);
    let e4 = ["animate", "circle", "defs", "desc", "ellipse", "g", "image", "line", "filter", "marker", "mask", "metadata", "path", "pattern", "polygon", "polyline", "rect", "stop", "switch", "symbol", "svg", "text", "tspan", "use", "view"];
    function e6(t) {
        if ("string" != typeof t || t.includes("-"))
            ;
        else if (e4.indexOf(t) > -1 || /[A-Z]/u.test(t))
            return !0;
        return !1
    }
    var e9 = t.i(43476);
    let e7 = (0,
    e3.createContext)({});
    t.s(["LayoutGroupContext", 0, e7], 31178);
    let e8 = (0,
    e3.createContext)({
        strict: !1
    })
    ...
    t.s(["MotionConfigContext", 0, it], 37806);
    let ie = (0,
    e3.createContext)({});
    function ii(t) {
    ...
    function il(t) {
        return t.startsWith("while") || t.startsWith("drag") && "draggable" !== t || t.startsWith("layout") || t.startsWith("onTap") || t.startsWith("onPan") || t.startsWith("onLayout") || ia.has(t)
    }
    let ih = t => !il(t);
    try {
        J = ( () => {
        ...
        "function" == typeof J && (ih = t => t.startsWith("on") ? !il(t) : J(t))
    } catch {}
    function iu(t) {
        return K(t) ? t.get() : t
    }
    let id = (0,
    e3.createContext)(null);
    function ic(t) {
        let e = (0,
        e3.useRef)(null);
    ...
    t.s(["PresenceContext", 0, id], 21476),
    t.s(["useConstant", 0, ic], 47414);
    let ip = t => (e, i) => {
        let n = (0,
        e3.useContext)(ie)
          , s = (0,
            ...
            return {
                latestValues: function(t, e, i, n) {
                    ...
                    let {initial: o, animate: a} = t
                      , l = ep(t)
                      , h = em(t);
                    e && h && !l && !1 !== t.inherit && (void 0 === o && (o = e.initial),
    ...
    let iw = Symbol.for("motionComponentSymbol")
      , iT = "data-" + eP("framerAppearId")
      , ib = (0,
    e3.createContext)({});
    function iS(t) {
        return t && "object" == typeof t && Object.prototype.hasOwnProperty.call(t, "current")
    }
    let iP = "u" > typeof window ? e3.useLayoutEffect : e3.useEffect;
    function iE(t, {forwardMotionProps: e=!1, type: i}={}, n, s) {
        n && function(t) {
            let e = ix();
            for (let i in t)
                e[i] = {
        ...
        function a(i, n) {
            ...
            }, {isStatic: c} = d, p = function(t) {
                let {initial: e, animate: i} = function(t, e) {
                    if (ep(t)) {
                        let {initial: e, animate: i} = t;
                        return {
                            initial: !1 === e || eu(e) ? e : void 0,
                            animate: eu(i) ? i : void 0
                        }
                    }
            ...
            if (!c && "u" > typeof window) {
                ...
                p.visualElement = function(t, e, i, n, s, r) {
                    ...
                    p.current && c.current && (c.current.manuallyAnimateOnMount = !0));
                    let m = c.current
                      , f = (0,
                    e3.useContext)(ib);
                    m && !m.projection && s && ("html" === m.type || "svg" === m.type) && function(t, e, i, n) {
                        let {layoutId: s, layout: r, drag: o, dragConstraints: a, layoutScroll: l, layoutRoot: h, layoutAnchor: u, layoutCrossfade: d} = e;
                    ...
                    let y = i[iT]
                      , v = (0,
                    e3.useRef)(!!y && "u" > typeof window && !window.MotionHandoffIsComplete?.(y) && window.MotionHasOptimisedAnimation?.(y));
                    return iP( () => {
                        p.current = !0,
                        m && (g.current = !0,
            ...
            e9.jsxs)(ie.Provider, {
                value: p,
                children: [l && p.visualElement ? (0,
                e9.jsx)(l, {
                    visualElement: p.visualElement,
                    ...d
                }) : null, function(t, e, i, {latestValues: n}, s, r=!1, o) {
                    let a = (o ?? e6(t) ? function(t, e, i, n) {
                        let s = (0,
                        e3.useMemo)( () => {
                            let i = io();
                            return eR(i, e, eB(n), t.transformTemplate, t.style),
                            {
                                ...i.attrs,
                                style: {
                                    ...i.style
                    ...
                    : function(t, e) {
                      ...
                      , l = function(t, e, i) {
                        let n = {};
                        for (let s in t)
                            ("values" !== s || "object" != typeof t.values) && !K(t[s]) && (ih(s) || !0 === i && il(s) || !e && !il(s) || t.draggable && s.startsWith("onDrag")) && (n[s] = t[s]);
                        return n
                    }(e, "string" == typeof t, r)
                      , h = t !== e3.Fragment ? {
                        ...l,
                      ...
                      , {children: u} = e
                      , d = (0,
                    e3.useMemo)( () => K(u) ? u.get() : u, [u]);
                    return (0,
                    e3.createElement)(t, {
                        ...h,
                        children: d
                    })
                }(t, i, (a = p.visualElement,
                h = (0,
                e3.useRef)(n),
                (0,
                e3.useInsertionEffect)( () => {
    ...
    t.s(["useIsomorphicLayoutEffect", 0, iP], 74008);
    class iA {
        constructor(t) {
            this.isMounted = !1,
            this.node = t
    ...
    function iM(t, e, i) {
        let n = t.getProps();
        return ex(n, e, void 0 !== i ? i : n.custom, t)
    }
    function iV(t, e) {
        if (t?.inherit && e) {
            let {inherit: i, ...n} = t;
    ...
    let ik = t => Array.isArray(t);
    function iD(t, e) {
        let i = t.getValue("willChange");
        if (K(i) && i.add)
            return i.add(e);
        if (!i && tP.WillChange) {
            let i = new tP.WillChange("auto");
    ...
    let iF = (t, e, i) => {
      ...
      , iO = [y, g, E];
    function iI(t) {
        let e = iO.find(e => e.test(t));
        if (tt(!!e, `'${t}' is not an animatable color. Use the equivalent color code instead.`, "color-not-animatable"),
        !e)
            return !1;
        let i = e.parse(t);
        return e === E && (i = function({hue: t, saturation: e, lightness: i, alpha: n}) {
            t /= 360,
            i /= 100;
            let s = 0
              , r = 0
    ...
    let iW = (t, e) => {
        ...
        return t => (s.red = iF(i.red, n.red, t),
        s.green = iF(i.green, n.green, t),
        s.blue = iF(i.blue, n.blue, t),
    ...
    function i$(t) {
        return "number" == typeof t ? iN : "string" == typeof t ? tr(t) ? ij : A.test(t) ? iW : iY : Array.isArray(t) ? iz : "object" == typeof t ? A.test(t) ? iW : iH : ij
    }
    function iz(t, e) {
        let i = [...t]
          , n = i.length
          , s = t.map( (t, i) => i$(t)(t, e[i]));
        return t => {
            for (let e = 0; e < n; e++)
                i[e] = s[e](t);
            return i
    ...
    function iH(t, e) {
        let i = {
          ...
          , n = {};
        for (let s in i)
            void 0 !== t[s] && void 0 !== e[s] && (n[s] = i$(t[s])(t[s], e[s]));
        return t => {
            for (let e in n)
                i[e] = n[e](t);
            return i
    ...
    let iY = (t, e) => {
        ...
        if (!(n.indexes.var.length === s.indexes.var.length && n.indexes.color.length === s.indexes.color.length && n.indexes.number.length >= s.indexes.number.length))
            return tt(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`, "complex-values-different"),
            ij(t, e);
        if (iU.has(t) && !s.values.length || iU.has(e) && !n.values.length)
            return iU.has(t) ? i => i <= 0 ? t : e : i => i >= 1 ? e : t;
        return iL(iz(function(t, e) {
            let i = []
              , n = {
                color: 0,
                var: 0,
    ...
    ;
    function iX(t, e, i) {
        return "number" == typeof t && "number" == typeof e && "number" == typeof i ? eI(t, e, i) : i$(t)(t, e)
    }
    let iK = t => {
        let e = ({timestamp: e}) => t(e);
        return {
            start: (t=!0) => tM.update(e, t),
            stop: () => tV(e),
            now: () => tC.isProcessing ? tC.timestamp : ei.now()
        }
    }
    ;
    function iG(t) {
    ...
    let i0 = ["duration", "bounce"]
      , i1 = ["stiffness", "damping", "mass"];
    function i2(t, e) {
        return e.some(e => void 0 !== t[e])
    }
    function i5(t=.3, e=.3) {
        let i, n, s, r, a, l, h = "object" != typeof t ? {
            visualDuration: t,
            keyframes: [0, 1],
            bounce: e
        } : t, {restSpeed: u, restDelta: d} = h, c = h.keyframes[0], p = h.keyframes[h.keyframes.length - 1], m = {
            done: !1,
            value: c
        }, {stiffness: f, damping: g, mass: y, duration: v, velocity: x, isResolvedFromDuration: w} = function(t) {
            let e = {
                velocity: 0,
                stiffness: 100,
                damping: 10,
            ...
            if (!i2(t, i1) && i2(t, i0))
                ...
                t.visualDuration) {
                    let i = 2 * Math.PI / (1.2 * t.visualDuration)
                      , n = i * i
                      , s = 2 * o(.05, 1, 1 - (t.bounce || 0)) * Math.sqrt(n);
                    e = {
                        ...e,
                        mass: 1,
                        stiffness: n,
                    ...
                    let i = function({duration: t=800, bounce: e=.3, velocity: i=0, mass: n=1}) {
                        let s, r;
                        tt(t <= t$(10), "Spring duration must be 10 seconds or less", "spring-duration-limit");
                        let a = 1 - e;
                        a = o(.05, 1, a),
                        t = o(.01, 10, t / 1e3),
                        a < 1 ? (s = e => {
                            let n = e * a
                              , s = n * t;
                            return .001 - (n - i) / iQ(e, a) * Math.exp(-s)
                        }
                        ,
                        r = e => {
                            let n = e * a * t
            ...
            ...h,
            velocity: -((h.velocity || 0) / 1e3)
        }), T = x || 0, b = g / (2 * Math.sqrt(f * y)), S = p - c, P = Math.sqrt(f / y) / 1e3, E = 5 > Math.abs(S);
        if (u || (u = E ? iq : i_),
        d || (d = E ? iZ : iJ),
        b < 1)
            s = iQ(P, b),
            r = (T + b * P * S) / s,
            i = t => p - Math.exp(-b * P * t) * (r * Math.sin(s * t) + S * Math.cos(s * t)),
            a = b * P * r + S * s,
            l = b * P * S - r * s,
            n = t => Math.exp(-b * P * t) * (a * Math.sin(s * t) + l * Math.cos(s * t));
        else if (1 === b) {
            i = t => p - Math.exp(-P * t) * (S + (T + P * S) * t);
            let t = T + P * S;
            ...
            i = e => {
                let i = Math.exp(-b * P * e)
                  , n = Math.min(t * e, 300);
                return p - i * ((T + b * P * S) * Math.sinh(n) + t * S * Math.cosh(n)) / t
            }
            ;
            let e = (T + b * P * S) / t
              , s = b * P * e - S * t
            ...
            next: t => {
                if (!w && b < 1) {
                    let e = Math.exp(-b * P * t)
                      ...
                      , n = Math.cos(s * t)
                      , o = p - e * (r * i + S * n);
                    return m.done = Math.abs(t$(e * (a * i + l * n))) <= u && Math.abs(p - o) <= d,
                    m.value = m.done ? p : o,
                    m
                }
                let e = i(t);
                return w ? m.done = t >= v : m.done = Math.abs(t$(n(t))) <= u && Math.abs(p - e) <= d,
                m.value = m.done ? p : e,
                m
            }
            ,
            toString: () => {
                let t = Math.min(iG(A), 2e4)
                  , e = t3(e => A.next(t * e).value, t, 30);
                return t + "ms " + e
            }
            ,
            toTransition: () => {}
    ...
    function i4({keyframes: t, velocity: e=0, power: i=.8, timeConstant: n=325, bounceDamping: s=10, bounceStiffness: r=500, modifyTarget: o, min: a, max: l, restDelta: h=.5, restSpeed: u}) {
        let d, c, p = t[0], m = {
            done: !1,
            value: p
        }, f = i * e, g = p + f, y = void 0 === o ? g : o(g);
        y !== g && (f = y - p);
    ...
    ;
    let i6 = (t, e, i) => (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
    function i9(t, e, i, n) {
        return t === e && i === n ? tS : s => 0 === s || 1 === s ? s : i6(function(t, e, i, n, s) {
            let r, o, a = 0;
            do
                (r = i6(o = e + (i - e) / 2, n, s) - t) > 0 ? i = o : e = o;
    ...
    let i7 = i9(.42, 0, 1, 1)
      , i8 = i9(0, 0, .58, 1)
      , nt = i9(.42, 0, .58, 1)
      , ne = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2
      , ni = t => e => 1 - t(1 - e)
      , nn = i9(.33, 1.53, .69, .99)
      , ns = ni(nn)
      , nr = ne(ns)
      , no = t => t >= 1 ? 1 : (t *= 2) < 1 ? .5 * ns(t) : .5 * (2 - Math.pow(2, -10 * (t - 1)))
      , na = t => 1 - Math.sin(Math.acos(t))
      , nl = ni(na)
      , nh = ne(na)
      , nu = {
        linear: tS,
      ...
      , nd = t => {
        if (t2(t)) {
            te(4 === t.length, "Cubic bezier arrays must contain four numerical values.", "cubic-bezier-length");
            let[e,i,n,s] = t;
            return i9(e, i, n, s)
        }
        return "string" == typeof t ? (te(void 0 !== nu[t], `Invalid easing type '${t}'`, "invalid-easing-type"),
        nu[t]) : t
    }
      , nc = (t, e, i) => {
        let n = e - t;
    ...
    ;
    function np(t, e, {clamp: i=!0, ease: n, mixer: s}={}) {
        let r = t.length;
        if (te(r === e.length, "Both input and output ranges must be the same length", "range-length"),
        1 === r)
            return () => e[0];
        if (2 === r && e[0] === e[1])
            return () => e[1];
        ...
        let l = function(t, e, i) {
            ...
            for (let i = 0; i < r; i++) {
                let r = s(t[i], t[i + 1]);
                e && (r = iL(Array.isArray(e) ? e[i] || tS : e, r)),
                n.push(r)
            }
            return n
        }(e, n, s)
          ...
          , u = i => {
            ...
            if (h > 1)
                for (; n < t.length - 2 && !(i < t[n + 1]); n++)
                    ;
            let s = nc(t[n], t[n + 1], i);
            return l[n](s)
        }
        ;
        return i ? e => u(o(t[0], t[r - 1], e)) : u
    }
    function nm(t) {
        let e = [0];
        return !function(t, e) {
    ...
    function nf({duration: t=300, keyframes: e, times: i, ease: n="easeInOut"}) {
        var s;
        let r = Array.isArray(n) && "number" != typeof n[0] ? n.map(nd) : nd(n)
          , o = {
            done: !1,
            value: e[0]
        }
          , a = np((s = i && i.length === e.length ? i : nm(e),
        s.map(e => e * t)), e, {
            ease: Array.isArray(r) ? r : e.map( () => r || nt).splice(0, e.length - 1)
        });
        return {
    ...
    t.s(["progress", 0, nc], 83920),
    t.s(["interpolate", 0, np], 44230),
    ...
    class nx extends t0 {
        ...
        initAnimation() {
            let {options: t} = this;
            ny(t);
            let {type: e=nf, repeat: i=0, repeatDelay: n=0, repeatType: s, velocity: r=0} = t
              , {keyframes: o} = t
              , a = e || nf;
            a !== nf && "number" != typeof o[0] && (this.mixKeyframes = iL(nv, iX(o[0], o[1])),
            o = [0, 100]);
            let l = a({
                ...t,
                keyframes: o
        ...
        tick(t, e=!1) {
            let i, {generator: n, totalDuration: s, mixKeyframes: r, mirroredGenerator: a, resolvedDuration: l, calculatedDuration: h} = this;
            if (null === this.startTime)
                return n.next(0);
            let {delay: u=0, keyframes: d, repeat: c, repeatType: p, repeatDelay: m, type: f, onUpdate: g, finalKeyframe: y} = this.options;
            ...
            if (c) {
                ...
                m && (i -= m / l)) : "mirror" === p && (T = a)),
                w = o(0, 1, i) * l
            }
            x ? (this.delayState.value = d[0],
            i = this.delayState) : i = T.next(w),
            r && !x && (i.value = r(i.value));
            let {done: b} = i;
            x || null === h || (b = this.playbackSpeed >= 0 ? this.currentTime >= s : this.currentTime <= 0);
            let S = null === this.holdTime && ("finished" === this.state || "running" === this.state && b);
            return S && f !== i4 && (i.value = tQ(d, this.options, y, this.speed)),
            g && g(i.value),
            S && this.finish(),
            i
        }
        ...
        getGeneratorVelocity() {
            ...
            return i3(t => this.generator.next(t).value, t, e)
        }
        get speed() {
    ...
    class nT extends t7 {
        constructor(t) {
            !function(t) {
                "string" == typeof t.ease && t.ease in nw && (t.ease = nw[t.ease])
            }(t),
            ny(t),
            super(t),
        ...
        updateMotionValue(t) {
            ...
            let a = new nx({
              ...
              , {name: d} = this.options;
            s && d && tX(s, d, u),
            e.setWithVelocity(a.sample(Math.max(0, l - h)).value, u, h),
            a.stop()
        }
    }
    let nb = (t, e) => "zIndex" !== e && !!("number" == typeof t || Array.isArray(t) || "string" == typeof t && (L.test(t) || "0" === t) && !t.startsWith("url("));
    function nS(t) {
        t.duration = 0,
        t.type = "keyframes"
    }
    let nP = /^(?:oklch|oklab|lab|lch|color|color-mix|light-dark)\(/
      , nE = new Set(["color", "backgroundColor", "outlineColor", "fill", "stroke", "borderColor", "borderTopColor", "borderRightColor", "borderBottomColor", "borderLeftColor"])
      , nA = tK( () => Object.hasOwnProperty.call(Element.prototype, "animate"));
    class nM extends t0 {
        constructor({autoplay: t=!0, delay: e=0, type: i="keyframes", repeat: n=0, repeatDelay: s=0, repeatType: r="loop", keyframes: o, name: a, motionValue: l, element: h, ...u}) {
            super(),
            this.stop = () => {
            ...
            const d = {
              ...
              , c = h?.KeyframeResolver || tO;
            this.keyframeResolver = new c(o, (t, e, i) => this.onKeyframesResolved(t, e, d, !i),a,l,h),
        ...
        onKeyframesResolved(t, e, i, n) {
            ...
            !function(t, e, i, n) {
                ...
                let r = t[t.length - 1]
                  , o = nb(s, e)
                  , a = nb(r, e);
                return tt(o === a, `You are trying to animate ${e} from "${s}" to "${r}". "${o ? r : s}" is not an animatable value.`, "value-not-animatable"),
                !!o && !!a && (function(t) {
                    let e = t[0];
                    if (1 === t.length)
                        return !0;
            ...
            (tP.instantAnimations || !l) && u?.(tQ(t, i, e)),
            t[0] = t[t.length - 1],
            nS(i),
            i.repeat = 0);
            let c = {
              ...
              , p = d && !h && function(t) {
                let {motionValue: e, name: i, repeatDelay: n, repeatType: s, damping: r, type: o, keyframes: a} = t;
                if (!(e?.owner?.current instanceof HTMLElement))
                    return !1;
                let {onUpdate: l, transformTemplate: h} = e.owner.getProps();
                return nA() && i && (t8.has(i) || nE.has(i) && function(t) {
                    for (let e = 0; e < t.length; e++)
                        if ("string" == typeof t[e] && nP.test(t[e]))
                            return !0;
                    return !1
                }(a)) && ("transform" !== i || !h) && !l && !n && "mirror" !== s && 0 !== r && "inertia" !== o
            }(c)
    ...
    let nV = {
      ...
      , nD = new Set(["when", "delay", "delayChildren", "staggerChildren", "staggerDirection", "repeat", "repeatType", "repeatDelay", "from", "elapsed"])
      , nR = (t, e, i, n={}, s, o) => a => {
        let l = iC(n, t) || {}
          , h = l.delay || n.delay || 0
          , {elapsed: u=0} = n;
        ...
        !function(t) {
            for (let e in t)
                if (!nD.has(e))
                    return !0;
            return !1
        }(l) && Object.assign(d, ( (t, {keyframes: e}) => e.length > 2 ? nC : r.has(t) ? t.startsWith("scale") ? {
            type: "spring",
            stiffness: 550,
            damping: 0 === e[1] ? 2 * Math.sqrt(550) : 30,
            restSpeed: 10
        } : nV : nk)(t, d)),
        d.duration && (d.duration = t$(d.duration)),
        d.repeatDelay && (d.repeatDelay = t$(d.repeatDelay)),
        void 0 !== d.from && (d.keyframes[0] = d.from);
        let c = !1;
        if (!1 !== d.type && (0 !== d.duration || d.repeatDelay) || (nS(d),
        0 === d.delay && (c = !0)),
        (tP.instantAnimations || tP.skipAnimations || s?.shouldSkipAnimations) && (c = !0,
        nS(d),
        d.delay = 0),
        ...
        c && !o && void 0 !== e.get()) {
            ...
            if (void 0 !== t)
                return void tM.update( () => {
                    d.onUpdate(t),
                    d.onComplete()
                }
                )
        }
        return l.isSync ? new nx(d) : new nM(d)
    }
    ;
    function nL(t, e, {delay: i=0, transitionOverride: n, type: s}={}) {
        ...
        for (let e in a) {
            ...
            if (window.MotionHandoffAnimation) {
                let i = t.props[iT];
                if (i) {
                    let t = window.MotionHandoffAnimation(i, e, tM);
        ...
        if (o) {
            let e = () => tM.update( () => {
                o && function(t, e) {
                    let {transitionEnd: i={}, transition: n={}, ...s} = iM(t, e) || {};
                    for (let e in s = {
                        ...s,
                        ...i
                    }) {
                        var r;
                        let i = ik(r = s[e]) ? r[r.length - 1] || 0 : r;
                        t.hasValue(e) ? t.getValue(e).set(i) : t.addValue(e, eo(i))
                    }
                }(t, o)
            }
            );
    ...
    function nj(t, e, i={}) {
        let n = iM(t, e, "exit" === i.type ? t.presenceContext?.custom : void 0)
          , {transition: s=t.getDefaultTransition() || {}} = n || {};
        i.transitionOverride && (s = i.transitionOverride);
        let r = n ? () => Promise.all(nL(t, n, i)) : () => Promise.resolve()
          , o = t.variantChildren && t.variantChildren.size ? (n=0) => {
            ...
            return function(t, e, i=0, n=0, s=0, r=1, o) {
                ...
                for (let l of t.variantChildren)
                    ...
                    a.push(nj(l, e, {
                        ...o,
                        delay: i + ("function" == typeof n ? 0 : n) + nB(t.variantChildren, l, n, s, r)
    ...
    function nQ(t) {
        return nJ(t) && "ownerSVGElement"in t
    }
    function n0(t, e, i) {
        if (null == t)
            return [];
    ...
    t.s(["resolveElements", 0, n0], 49652);
    let n1 = new WeakMap
      , n2 = (t, e, i) => (n, s) => s && s[0] ? s[0][t + "Size"] : nQ(n) && "getBBox"in n ? n.getBBox()[e] : n[i]
      , n5 = n2("inline", "width", "offsetWidth")
      , n3 = n2("block", "height", "offsetHeight");
    ...
    function n7(t, e) {
        let s;
        return "function" == typeof t ? (n9.add(t),
        n || (n = () => {
            let t = {
                get width() {
        ...
        () => {
            n9.delete(t),
            n9.size || "function" != typeof n || (window.removeEventListener("resize", n),
            n = void 0)
        }
    ...
    let n8 = new Set(["BUTTON", "INPUT", "SELECT", "TEXTAREA", "A"])
      , st = new Set(["INPUT", "SELECT", "TEXTAREA"])
      , se = t => "mouse" === t.pointerType ? "number" != typeof t.button || t.button <= 0 : !1 !== t.isPrimary;
    function si(t) {
        return {
            point: {
                x: t.pageX,
    ...
    function sn(t, e, i, n) {
        return nH(t, e, t => se(t) && i(t, si(t)), n)
    }
    let ss = ({current: t}) => t ? t.ownerDocument.defaultView : null
      , sr = (t, e) => Math.abs(t - e)
      , so = new Set(["auto", "scroll"]);
    class sa {
        constructor(t, e, {transformPagePoint: i, contextWindow: n=window, dragSnapToOrigin: s=!1, distanceThreshold: r=3, element: o}={}) {
            ...
            this.updatePoint = () => {
                ...
                if (!(this.lastMoveEvent && this.lastMoveEventInfo))
                    return;
                this.lastRawMoveEventInfo && (this.lastMoveEventInfo = sl(this.lastRawMoveEventInfo, this.transformPagePoint));
                ...
                Math.sqrt(sr(t.x, e.x) ** 2 + sr(t.y, e.y) ** 2) >= this.distanceThreshold);
                if (!n && !s)
                    return;
                let {point: r} = i
                  , {timestamp: o} = tC;
            ...
            this.handlePointerMove = (t, e) => {
                ...
                this.lastMoveEventInfo = sl(e, this.transformPagePoint),
                tM.update(this.updatePoint, !0)
            }
            ,
            this.handlePointerUp = (t, e) => {
                ...
                !(this.lastMoveEvent && this.lastMoveEventInfo))
                    return;
                let r = su("pointercancel" === t.type ? this.lastMoveEventInfo : sl(e, this.transformPagePoint), this.history);
            ...
            const a = sl(si(t), this.transformPagePoint)
              , {point: l} = a
              , {timestamp: h} = tC;
            this.history = [{
                ...l,
            ...
            u && u(t, su(a, this.history)),
            this.removeListeners = iL(sn(this.contextWindow, "pointermove", this.handlePointerMove), sn(this.contextWindow, "pointerup", this.handlePointerUp), sn(this.contextWindow, "pointercancel", this.handlePointerUp)),
        ...
        startScrollTracking(t) {
            ...
            for (; e; ) {
                ...
                (so.has(t.overflowX) || so.has(t.overflowY)) && this.scrollPositions.set(e, {
                    x: e.scrollLeft,
                    y: e.scrollTop
                }),
                e = e.parentElement
    ...
    function su({point: t}, e) {
        return {
            ...
            velocity: function(t) {
                ...
                i === t[0] && t.length > 2 && n.timestamp - i.timestamp > 2 * t$(.1) && (i = t[1]);
    ...
    class sy {
        ...
        start(t, {snapToCursor: e=!1, distanceThreshold: i}={}) {
            ...
            if (n && !1 === n.isPresent)
                return;
            let s = t => {
                e && this.snapToCursor(si(t).point),
                this.stopAnimation()
            }
              , r = (t, e) => {
                ...
                this.openDragLock = function(t) {
                    if ("x" === t || "y" === t)
                        if (nY[t])
                            ...
                            ;
                    return nY.x || nY.y ? null : (nY.x = nY.y = !0,
                    () => {
                        nY.x = nY.y = !1
                    }
                    )
                ...
                nz(t => {
                    ...
                    if (w.test(e)) {
                        ...
                        if (i && i.layout) {
                            ...
                            n && (e = nX(n) * (parseFloat(e) / 100))
                        }
                    }
                    this.originPoint[t] = e
                }
                ),
                s && tM.update( () => s(t, e), !1, !0),
        ...
        updateAxis(t, e, i) {
            ...
            if (!i || !sx(t, n, this.currentDirection))
                return;
            let s = this.getAxisMotionValue(t)
              , r = this.originPoint[t] + i[t];
            this.constraints && this.constraints[t] && (r = function(t, {min: e, max: i}, n) {
                return void 0 !== e && t < e ? t = n ? eI(e, t, n.min) : Math.max(t, e) : void 0 !== i && t > i && (t = n ? eI(i, t, n.max) : Math.min(t, i)),
                t
        ...
        resolveConstraints() {
            let {dragConstraints: t, dragElastic: e} = this.getProps()
              ...
              , n = this.constraints;
            t && iS(t) ? this.constraints || (this.constraints = this.resolveRefConstraints()) : t && i ? this.constraints = function(t, {top: e, left: i, bottom: n, right: s}) {
                return {
                    x: sc(t.x, i, s),
                    y: sc(t.y, e, n)
                }
            ...
            n !== this.constraints && !iS(t) && i && this.constraints && !this.hasMutatedConstraints && nz(t => {
                var e, n;
                let s;
        ...
        resolveRefConstraints() {
            ...
            if (!e || !iS(e))
                return !1;
            let n = e.current;
            te(null !== n, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.", "drag-constraints-ref");
        ...
        startAnimation(t) {
            let {drag: e, dragMomentum: i, dragElastic: n, dragTransition: s, dragSnapToOrigin: r, onDragTransitionEnd: o} = this.getProps()
              , a = this.constraints || {};
            return Promise.all(nz(o => {
                if (!sx(o, e, this.currentDirection))
                    return;
                let l = a && a[o] || {};
                (!0 === r || r === o) && (l = {
                    min: 0,
        ...
        startAxisValueAnimation(t, e) {
            ...
            return iD(this.visualElement, t),
            i.start(nR(t, i, 0, e, this.visualElement, !1))
        }
        stopAnimation() {
        ...
        snapToCursor(t) {
            nz(e => {
                ...
                if (!sx(e, i, this.currentDirection))
                    return;
        ...
        scalePositionWithinConstraints() {
            ...
            nz(t => {
                ...
                if (e && !1 !== this.constraints) {
                    ...
                    r = .5,
                    a = nX(i),
                    (l = nX(s)) > a ? r = nc(s.min, s.max - a, i.min) : a > l && (r = nc(i.min, i.max - l, s.min)),
                    o(0, 1, r))
                }
            }
            );
        ...
        addListeners() {
            ...
            let e = this.visualElement.current
              , i = sn(e, "pointerdown", t => {
                let {drag: i, dragListener: n=!0} = this.getProps()
                  , s = t.target
                  , r = s !== e && (st.has(s.tagName) || !0 === s.isContentEditable);
                i && n && !r && this.start(t)
            }
            )
              , n = () => {
                ...
                iS(a) && a.current && (this.constraints = this.resolveRefConstraints(),
                t || (i = e,
                n = a.current,
                r = n7(i, sv(s = () => this.scalePositionWithinConstraints())),
                o = n7(n, sv(s)),
                t = () => {
                    r(),
                    o()
            ...
            s.updateLayout()),
            tM.read(n);
            let o = nH(window, "resize", () => this.scalePositionWithinConstraints())
              , a = s.addEventListener("didUpdate", ({delta: t, hasLayoutChanged: e}) => {
                this.isDragging && e && (nz(e => {
                    let i = this.getAxisMotionValue(e);
    ...
    function sS(t=!0) {
        ...
        , [t]);
        let o = (0,
        e3.useCallback)( () => t && n && n(r), [r, n, t]);
        return !i && n ? [!1, o] : [!0]
    }
    t.s(["usePresence", 0, sS], 64978);
    let sP = !1;
    class sE extends sb.Component {
        componentDidMount() {
        ...
        getSnapshotBeforeUpdate(t) {
            ...
            t.isPresent !== s && (s ? r.promote() : r.relegate() || tM.postRender( () => {
                let t = r.getStack();
    ...
    let sM = ["borderTopLeftRadius", "borderTopRightRadius", "borderBottomLeftRadius", "borderBottomRightRadius"]
      , sV = sM.length
      , sC = t => "string" == typeof t ? parseFloat(t) : t
      , sk = t => "number" == typeof t || T.test(t);
    function sD(t, e) {
    ...
    let sR = sB(0, .5, nl)
      , sL = sB(.5, .95, tS);
    function sB(t, e, i) {
        return n => n < t ? 0 : n > e ? 1 : i(nc(t, e, n))
    }
    function sj(t, e) {
        t.min = e.min,
        t.max = e.max
    ...
    let sU = ["x", "scaleX", "originX"]
      , sN = ["y", "scaleY", "originY"];
    function s$(t, e, i, n) {
        sW(t.x, e, sU, i ? i.x : void 0, n ? n.x : void 0),
        sW(t.y, e, sN, i ? i.y : void 0, n ? n.y : void 0)
    }
    function sz(t) {
        ...
        add(t) {
            ...
            for (let e = this.members.length - 1; e >= 0; e--) {
                ...
                if (i === t || i === this.lead || i === this.prevLead)
                    continue;
                let n = i.instance;
                n && !1 !== n.isConnected || i.snapshot || (tH(this.members, i),
                i.unmount())
            }
            t.scheduleRender()
        }
        remove(t) {
            if (tH(this.members, t),
    ...
    function s2({attachResizeListener: t, defaultParent: e, measureScroll: i, checkIsScrollRoot: n, resetTransform: s}) {
        return class {
            constructor(t={}, i=e?.()) {
                this.id = s0++,
                this.animationId = 0,
                ...
                this.root === this && (this.nodes = new sJ)
            }
            addEventListener(t, e) {
                return this.eventHandlers.has(t) || this.eventHandlers.set(t, new tY),
            ...
            mount(e) {
                if (this.instance)
                    return;
                this.isSVG = nQ(e) && !(nQ(e) && "svg" === e.tagName),
                this.instance = e;
                ...
                t) {
                    ...
                    t(e, () => {
                        ...
                        if (t !== n) {
                            ...
                            tM.setup(r, !0),
                            i = () => tV(r),
                            sT.hasAnimatedSinceResize && (sT.hasAnimatedSinceResize = !1,
                ...
                !1 !== this.options.animate && s && (i || n) && this.addEventListener("didUpdate", ({delta: t, hasLayoutChanged: e, hasRelativeLayoutChanged: i, layout: n}) => {
                    ...
                    let r = this.options.transition || s.getDefaultTransition() || rd
                      ...
                      , l = !this.targetLayout || !sK(this.targetLayout, n)
                      , h = !e && i;
            ...
            willUpdate(t=!0) {
                ...
                if (window.MotionCancelOptimisedAnimation && !this.hasCheckedOptimisedAppear && function t(e) {
                    ...
                    if (window.MotionHasOptimisedAnimation(n, "transform")) {
                        ...
                        window.MotionCancelOptimisedAnimation(n, "transform", tM, !(t || i))
                    }
                    let {parent: s} = e;
            ...
            update() {
                ...
                this.isUpdateBlocked()) {
                    ...
                    this.updateBlockedByResize = !1,
                    this.clearAllSnapshots(),
                    t && this.nodes.forEach(s8),
                    this.nodes.forEach(s7);
                    return
                }
                if (this.animationId <= this.animationCommitId)
                    return void this.nodes.forEach(rt);
                this.animationCommitId = this.animationId,
                this.isUpdating ? (this.isUpdating = !1,
                this.nodes.forEach(re),
                this.nodes.forEach(ri),
                this.nodes.forEach(s5),
                this.nodes.forEach(s3)) : this.nodes.forEach(rt),
                this.clearAllSnapshots();
                let t = ei.now();
                tC.delta = o(0, 1e3 / 60, t - tC.timestamp),
                tC.timestamp = t,
                tC.isProcessing = !0,
                tk.update.process(tC),
                tk.preRender.process(tC),
                tk.render.process(tC),
                tC.isProcessing = !1
            }
            didUpdate() {
                this.updateScheduled || (this.updateScheduled = !0,
                et.read(this.scheduleUpdate))
            }
            clearAllSnapshots() {
                this.nodes.forEach(s9),
                this.sharedNodes.forEach(ra)
            }
            scheduleUpdateProjection() {
                this.projectionUpdateScheduled || (this.projectionUpdateScheduled = !0,
                tM.preRender(this.updateProjection, !1, !0))
            }
            ...
            updateSnapshot() {
                ...
                !this.snapshot || nX(this.snapshot.measuredBox.x) || nX(this.snapshot.measuredBox.y) || (this.snapshot = void 0))
            }
            updateLayout() {
            ...
            resetTransform() {
                ...
                t && this.instance && (e || eK(this.latestValues) || r) && (s(this.instance, n),
                this.shouldResetTransform = !1,
                this.scheduleRender())
            }
            measure(t=!0) {
            ...
            measurePageBox() {
                ...
                if (!(this.scroll?.wasRoot || this.path.some(rg))) {
            ...
            removeElementScroll(t) {
                ...
                for (let i = 0; i < this.path.length; i++) {
                    ...
                    n !== this.root && s && r.layoutScroll && (s.wasRoot && sF(e, t),
                    eJ(e.x, s.offset.x),
                    eJ(e.y, s.offset.y))
                }
                return e
            ...
            applyTransform(t, e=!1, i) {
                ...
                for (let t = 0; t < this.path.length; t++) {
                    let i = this.path[t];
                    !e && i.options.layoutScroll && i.scroll && i !== i.root && (eJ(n.x, -i.scroll.offset.x),
                    eJ(n.y, -i.scroll.offset.y)),
                    eK(i.latestValues) && e1(n, i.latestValues, i.layout?.layoutBox)
                }
                return eK(this.latestValues) && e1(n, this.latestValues, this.layout?.layoutBox),
                n
            }
            removeTransform(t) {
                let e = X();
                ...
                for (let t = 0; t < this.path.length; t++) {
                    let i, n = this.path[t];
                    eK(n.latestValues) && (n.instance && (eX(n.latestValues) && n.updateSnapshot(),
                    sF(i = X(), n.measurePageBox())),
                    s$(e, n.latestValues, n.snapshot?.layoutBox, i))
                }
                return eK(this.latestValues) && s$(e, this.latestValues),
                e
            }
            setTargetDelta(t) {
                this.targetDelta = t,
            ...
            forceRelativeParentToResolveTarget() {
                this.relativeParent && this.relativeParent.resolvedRelativeTargetAt !== tC.timestamp && this.relativeParent.resolveTargetDelta(!0)
            }
            resolveTargetDelta(t=!1) {
                ...
                this.relativeTarget || this.targetDelta) {
                    ...
                    this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target) {
                        ...
                        this.targetDelta ? (this.resumingFrom ? this.applyTransform(this.layout.layoutBox, !1, this.target) : sF(this.target, this.layout.layoutBox),
                        eZ(this.target, this.targetDelta)) : sF(this.target, this.layout.layoutBox);
            ...
            getClosestProjectingParent() {
                if (!(!this.parent || eX(this.parent.latestValues) || eG(this.parent.latestValues)))
            ...
            createRelativeTarget(t, e, i) {
                ...
                nZ(this.relativeTargetOrigin, e, i, this.options.layoutAnchor || void 0),
            ...
            calcProjection() {
                ...
                !function(t, e, i, n=!1) {
                    ...
                    if (o) {
                        ...
                        for (let a = 0; a < o; a++) {
                            ...
                            (!o || !o.props.style || "contents" !== o.props.style.display) && (n && s.options.layoutScroll && s.scroll && s !== s.root && (eJ(t.x, -s.scroll.offset.x),
                            eJ(t.y, -s.scroll.offset.y)),
                            r && (e.x *= r.x.scale,
                            e.y *= r.y.scale,
                            eZ(t, r)),
                            n && eK(s.latestValues) && e1(t, s.latestValues, s.layout?.layoutBox))
                        }
                ...
                this.projectionDelta && this.prevProjectionDelta ? (sO(this.prevProjectionDelta.x, this.projectionDelta.x),
                sO(this.prevProjectionDelta.y, this.projectionDelta.y)) : this.createProjectionDeltas(),
                nG(this.projectionDelta, this.layoutCorrected, a, this.latestValues),
                this.treeScale.x === r && this.treeScale.y === o && sq(this.projectionDelta.x, this.prevProjectionDelta.x) && sq(this.projectionDelta.y, this.prevProjectionDelta.y) || (this.hasProjected = !0,
                this.scheduleRender(),
            ...
            setAnimationOrigin(t, e=!1) {
                let i, n = this.snapshot, s = n ? n.latestValues : {}, r = {
                    ...this.latestValues
                }, o = H();
                ...
                let a = X()
                  ...
                  , d = !!(l && !u && !0 === this.options.crossfade && !this.path.some(ru));
                this.animationProgress = 0,
                this.mixTargetDelta = e => {
                    ...
                    this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout) {
                        var h, c, p, m, f, g;
                        nZ(a, this.layout.layoutBox, this.relativeParent.layout.layoutBox, this.options.layoutAnchor || void 0),
                    ...
                    function(t, e, i, n, s, r) {
                        s ? (t.opacity = eI(0, i.opacity ?? 1, sR(n)),
                        t.opacityExit = eI(e.opacity ?? 1, 0, sL(n))) : r && (t.opacity = eI(e.opacity ?? 1, i.opacity ?? 1, n));
                        for (let s = 0; s < sV; s++) {
                            let r = sM[s]
                              , o = sD(e, r)
                              , a = sD(i, r);
                            ...
                            a || (a = 0),
                            0 === o || 0 === a || sk(o) === sk(a) ? (t[r] = Math.max(eI(sC(o), sC(a), n), 0),
                            (w.test(a) || w.test(o)) && (t[r] += "%")) : t[r] = a)
                        }
                        (e.rotate || i.rotate) && (t.rotate = eI(e.rotate || 0, i.rotate || 0, n))
            ...
            startAnimation(t) {
                ...
                this.pendingAnimation && (tV(this.pendingAnimation),
                this.pendingAnimation = void 0),
                this.pendingAnimation = tM.update( () => {
                    var e, i, n;
                    let s;
                    sT.hasAnimatedSinceResize = !0,
                    t1.layout++,
                    this.motionValue || (this.motionValue = eo(0)),
            ...
            resetSkewAndRotation() {
                ...
                !e)
                    return;
                let n = {};
                i.z && s1("z", t, n, this.animationValues);
                for (let e = 0; e < sQ.length; e++)
                    s1(`rotate${sQ[e]}`, t, n, this.animationValues),
                    s1(`skew${sQ[e]}`, t, n, this.animationValues);
            ...
            applyProjectionStyles(t, e) {
                ...
                if (this.needsReset) {
                    ...
                    t.visibility = "",
                    t.opacity = "",
                    t.pointerEvents = iu(e?.pointerEvents) || "",
                ...
                if (!this.projectionDelta || !this.layout || !n.target) {
                    ...
                    t.pointerEvents = iu(e?.pointerEvents) || ""),
                    this.hasProjected && !eK(this.latestValues) && (t.transform = i ? i({}, "") : "none",
                    this.hasProjected = !1);
                    return
                }
                t.visibility = "";
                ...
                eW) {
                    if (void 0 === s[e])
                        continue;
                    let {correct: i, applyTo: o, isCSSVariable: a} = eW[e]
                ...
                this.options.layoutId && (t.pointerEvents = n === this ? iu(e?.pointerEvents) || "" : "none")
            }
            clearSnapshot() {
    ...
    function s3(t) {
        ...
        if (t.isLead() && t.layout && e && t.hasListeners("didUpdate")) {
            ...
            if ("size" === s)
                ...
                let t = "x" === s ? "y" : "x";
                sj(r ? e.measuredBox[t] : e.layoutBox[t], i[t])
            } else
                rf(s, e.layoutBox, i) && nz(n => {
            ...
            nG(o, i, e.layoutBox);
            let a = H();
            r ? nG(a, t.applyTransform(n, !0), e.measuredBox) : nG(a, i, e.layoutBox);
            let l = !sH(o)
              , h = !1;
            if (!t.resumeFrom) {
                ...
                if (n && !n.resumeFrom) {
                    ...
                    if (s && r) {
                        let o = t.options.layoutAnchor || void 0
                          , a = X();
                        nZ(a, e.layoutBox, s.layoutBox, o);
                        let l = X();
                        nZ(l, i, r.layoutBox, o),
                        sK(a, l) || (h = !0),
    ...
    function rh(t, e, i, n) {
        t.min = eI(e.min, i.min, n),
        t.max = eI(e.max, i.max, n)
    }
    function ru(t) {
    ...
    let rd = {
      ...
      , rc = t => "u" > typeof navigator && navigator.userAgent && navigator.userAgent.toLowerCase().includes(t)
      , rp = rc("applewebkit/") && !rc("chrome/") ? Math.round : tS;
    function rm(t) {
        t.min = rp(t.min),
        t.max = rp(t.max)
    }
    function rf(t, e, i) {
        return "position" === t || "preserve-aspect" === t && !(.2 >= Math.abs(sG(e) - sG(i)))
    }
    function rg(t) {
    ...
    function rT(t, e, i) {
        ...
        let s = n["onHover" + i];
        s && tM.postRender( () => s(e, si(e)))
    }
    function rb(t) {
        return nJ(t) && "offsetHeight"in t && !("ownerSVGElement"in t)
    }
    t.s(["isHTMLElement", 0, rb], 72846);
    let rS = (t, e) => !!e && (t === e || rS(t, e.parentElement))
      , rP = new WeakSet;
    function rE(t) {
        return e => {
            "Enter" === e.key && t(e)
    ...
    let rk = new WeakMap
      ...
      , rj = function(t, e) {
        ...
        return new Proxy( (t, e) => n(t, e),{
            get: (s, r) => "create" === r ? n : (i.has(r) || i.set(r, iE(r, void 0, t, e)),
            i.get(r))
        })
    }({
        animation: {
                ...
                constructor(t) {
                    ...
                    t.animationState || (t.animationState = function(t) {
                        let e = e => Promise.all(e.map( ({animation: e, options: i}) => (function(t, e, i={}) {
                            ...
                            Array.isArray(e))
                                n = Promise.all(e.map(e => nj(t, e, i)));
                            else if ("string" == typeof e)
                                n = nj(t, e, i);
                            else {
                                let s = "function" == typeof e ? iM(t, e, i.custom) : e;
                                n = Promise.all(nL(t, s, i))
                            }
                            return n.then( () => {
                          ...
                          , s = !1
                          , r = e => (i, n) => {
                            let s = iM(t, n, "exit" === e ? t.presenceContext?.custom : void 0);
                            if (s) {
                        ...
                        function o(o) {
                            ...
                            for (let e = 0; e < nW; e++) {
                                ...
                                !g.isActive && null === x || !y && !g.prevProp || eh(y) || "boolean" == typeof y)
                                    continue;
                                ...
                                let T = (p = g.prevProp,
                                "string" == typeof (m = y) ? m !== p : !!Array.isArray(m) && !nO(m, p))
                                  , b = T || f === o && g.isActive && !w && v || e > c && v
                                  , S = !1
                                ...
                                for (let t in M) {
                                    ...
                                    if (!d.hasOwnProperty(t))
                                        (ik(e) && ik(i) ? nO(e, i) : e === i) ? void 0 !== e && u.has(t) ? V(t) : g.protectedKeys[t] = !0 : null != e ? V(t) : u.add(t)
                                }
                                g.prevProp = y,
                                ...
                                b && k && h.push(...P.map(e => {
                                    ...
                                    if ("string" == typeof e && (n || s) && !C && t.manuallyAnimateOnMount && t.parent) {
                                        ...
                                        if (n.enteringChildren && s) {
                                            ...
                                            i.delay = nB(n.enteringChildren, t, e)
                                        }
                                    }
                                    return {
                                        animation: e,
                            ...
                            if (u.size) {
                                ...
                                if ("boolean" != typeof a.initial) {
                                    let i = iM(t, Array.isArray(a.initial) ? a.initial[0] : a.initial);
                            ...
                            let f = !!h.length;
                            return n && (!1 === a.initial || a.initial === a.animate) && !t.manuallyAnimateOnMount && (f = !1),
                            n = !1,
                            s = !1,
                ...
                startObserver() {
                    ...
                    let {viewport: i={}} = this.node.getProps()
                      ...
                      , a = {
                        ...
                        rootMargin: s,
                        threshold: "number" == typeof r ? r : rB[r]
                    }
                      , l = t => {
                    ...
                    e = function({root: t, ...e}) {
                        ...
                        let n = rD.get(i)
                          , s = JSON.stringify(e);
                        return n[s] || (n[s] = new IntersectionObserver(rL,{
                            root: t,
                            ...e
                        })),
                        n[s]
                ...
                mount() {
                    ...
                    this.unmount = function(t, e, i={}) {
                        let[n,s,r] = rw(t, i)
                          , o = t => {
                            ...
                            if (!rM(t) || rV.has(t))
                                return;
                            rP.add(n),
                            i.stopPropagation && rV.add(t);
                            let r = e(n, t)
                              , o = (t, e) => {
                                window.removeEventListener("pointerup", a),
                                window.removeEventListener("pointercancel", l),
                                rP.has(n) && rP.delete(n),
                                rM(t) && "function" == typeof r && r(t, {
                                    success: e
                                })
                            }
                              , a = t => {
                                o(t, n === window || n === document || i.useGlobalTarget || rS(n, t.target))
                            }
                              , l = t => {
                                o(t, !1)
                            }
                        ...
                        return n.forEach(t => {
                            ...
                            rb(t)) && (t.addEventListener("focus", t => ( (t, e) => {
                                ...
                                let n = rE( () => {
                                    ...
                                    i.addEventListener("blur", () => rA(i, "cancel"), e)
                                }
                                );
                            ...
                            n8.has(t.tagName) || !0 === t.isContentEditable || t.hasAttribute("tabindex") || (t.tabIndex = 0))
                        }
                        ),
                        r
                    }(t, (t, e) => (rC(this.node, e, "Start"),
                    (t, {success: e}) => rC(this.node, t, e ? "End" : "Cancel")), {
                        useGlobalTarget: e,
        ...
        focus: {
            Feature: class extends iA {
                ...
                mount() {
                    this.unmount = iL(nH(this.node.current, "focus", () => this.onFocus()), nH(this.node.current, "blur", () => this.onBlur()))
                }
                unmount() {}
            }
        },
                    ...
                    t && (this.unmount = function(t, e, i={}) {
                        ...
                        return n.forEach(t => {
                            ...
                            t.addEventListener("pointerenter", n => {
                                if ("touch" === n.pointerType || nY.x || nY.y)
                                    return;
                                r = !1;
                                let o = e(t, n);
    ...
    }, (t, e) => e.isSVG ?? e6(t) ? new ez(e) : new e5(e,{
        allowProjection: t !== e3.Fragment
    }));
    t.s(["motion", 0, rj], 46932)
}
, 10542, 12381, 95420, t => {
    "use strict";
    var e = t.i(30551)
    ...
    function a(t, e) {
        ...
        ;
        return o.frame.preUpdate(n, !0),
        () => (0,
        o.cancelFrame)(n)
    }
    function l(t) {
        return !("u" < typeof window) && (t ? (0,
        e.supportsViewTimeline)() : (0,
        e.supportsScrollTimeline)())
    }
    var h = t.i(61327)
      , u = t.i(83920)
      , d = t.i(25791);
    ...
    function m(t, e, i, n) {
        let s = i[e]
          , {length: r, position: o} = p[e]
          , a = s.current
          , l = i.time;
        s.current = Math.abs(t[`scroll${o}`]),
        s.scrollLength = t[`scroll${r}`] - t[`client${r}`],
        s.offset.length = 0,
        s.offset[0] = 0,
        s.offset[1] = s.scrollLength,
        s.progress = (0,
        u.progress)(0, s.scrollLength, s.current);
        let h = n - l;
        s.velocity = h > 50 ? 0 : (0,
        d.velocityPerSecond)(s.current - a, h)
    }
    t.i(47167);
    var f = t.i(44230)
      , g = t.i(15923)
    ...
    let T = [0, 0]
      ...
      , M = new WeakMap
      , V = new WeakMap
      , C = t => t === document.scrollingElement ? window : t;
    function k(t, {container: e=document.scrollingElement, trackContentSize: i=!1, ...n}={}) {
        if (!e)
            return r.noop;
        let s = A.get(e);
        s || (s = new Set,
        ...
        let a = function(t, e, i, n={}) {
            return {
                measure: e => {
                    ...
                    m(t, "y", i, e),
                    i.time = e,
                    (n.offset || n.target) && function(t, e, i) {
                        let {offset: n=b} = i
                          , {target: s=t, axis: r="y"} = i
                          , o = "y" === r ? "height" : "width"
                          , a = s !== t ? function(t, e) {
                            let i = {
                                x: 0,
                        ...
                        for (let t = 0; t < d; t++) {
                            let i = function(t, e, i, n) {
                                let s = Array.isArray(t) ? t : T
                                  , r = 0;
                                return "number" == typeof t ? s = [t, t] : "string" == typeof t && (s = (t = t.trim()).includes(" ") ? t.split(" ") : [t, x[t] ? t : "0"]),
                                (r = w(s[0], i, n)) - w(s[1], e)
                            }(n[t], h[o], l[o], a[r]);
                        ...
                        u && (e[r].interpolate = (0,
                        f.interpolate)(e[r].offset, (0,
                        g.defaultOffset)(n), {
                            clamp: !1
                        }),
                        e[r].interpolatorOffsets = [...e[r].offset]),
                        e[r].progress = (0,
                        y.clamp)(0, 1, e[r].interpolate(e[r].current))
                    }(t, i, n)
                }
                ,
                notify: () => e(i)
        ...
        !P.has(e)) {
            let t = () => {
                for (let t of s)
                    t.measure(o.frameData.timestamp);
                o.frame.preUpdate(i)
            }
              , i = () => {
                for (let t of s)
            ...
            let r = C(e);
            window.addEventListener("resize", n),
            e !== document.documentElement && E.set(e, (0,
            h.resize)(e, n)),
        ...
        () => {
            ...
            let i = P.get(e);
            P.delete(e),
            i && (C(e).removeEventListener("scroll", i),
            E.get(e)?.(),
    ...
    let D = [[[[0, 1], [1, 1]], "entry"], [[[0, 0], [1, 0]], "exit"], [[[1, 0], [0, 1]], "cover"], [b, "contain"]]
      , R = {
        start: 0,
        end: 1
    };
    ...
    function F({source: t, container: e, ...i}) {
        ...
        return o[a] || (i.target && l(i.target) ? L(i.offset) ? o[a] = new ViewTimeline({
            subject: i.target,
            axis: n
        }) : o[a] = j({
            container: e,
            ...i
        }) : l() ? o[a] = new ScrollTimeline({
            source: e,
            axis: n
        }) : o[a] = j({
            container: e,
    ...
    function O(t, {axis: e="y", container: i=document.scrollingElement, ...n}={}) {
        var s, o;
        let h, u, d;
        if (!i)
            return r.noop;
        ...
        o = c,
        2 === s.length ? k(t => {
            s(t[o.axis].progress, t)
        }
        , o) : a(s, F(o))) : (h = F(c),
        u = c.target ? L(c.offset) : void 0,
        d = c.target ? l(c.target) && !!u : l(),
        t.attachTimeline({
            timeline: d ? h : void 0,
            ...u && d && {
    ...
    t.s(["useScroll", 0, function({container: t, target: i, ...r}={}) {
        var o;
        let a = (0,
        I.useConstant)(U);
        o = r.offset,
        !("u" < typeof window) && (i ? (0,
        e.supportsViewTimeline)() && !!L(o) : (0,
        e.supportsScrollTimeline)()) && (a.scrollXProgress.accelerate = $("x", r, t, i),
        a.scrollYProgress.accelerate = $("y", r, t, i));
        let l = (0,
        s.useRef)(null)
          , h = (0,
        s.useRef)(!1)
          , u = (0,
        s.useCallback)( () => (l.current = O( (t, {x: e, y: i}) => {
        ...
        n.invariant)(!N(t), "Container ref is defined but not hydrated", "use-scroll-ref"),
        (0,
        n.invariant)(!N(i), "Target ref is defined but not hydrated", "use-scroll-ref"),
        u()) : void 0, [u]),
        a
    }
    ], 10542);
    ...
    function H(t, e) {
        let n = function(t) {
            ...
            i.motionValue)(t))
              , {isStatic: n} = (0,
            s.useContext)(z.MotionConfigContext);
            if (n) {
                let[,i] = (0,
                s.useState)(t);
                (0,
                s.useEffect)( () => e.on("change", i), [])
            }
            return e
        }(e())
          , r = () => n.set(e());
    ...
    t.s(["useCombineMotionValues", 0, H], 12381);
    function Y(t, e) {
        let i = (0,
        I.useConstant)( () => []);
        return H(t, () => {
    ...
    t.s(["useTransform", 0, function t(e, n, s, r) {
        if ("function" == typeof e) {
            let t;
            return i.collectMotionValues.current = [],
            e(),
            t = H(i.collectMotionValues.current, e),
            i.collectMotionValues.current = void 0,
            t
        }
        if (void 0 !== s && !Array.isArray(s) && "function" != typeof n) {
            var o = e
              , a = n
              , l = s
              , h = r;
            let i = (0,
            I.useConstant)( () => Object.keys(l))
              , u = (0,
            I.useConstant)( () => ({}));
            for (let e of i)
                u[e] = t(o, a, l[e], h);
        ...
        let u = "function" == typeof n ? n : function(...t) {
          ...
          , d = Array.isArray(e) ? Y(e, u) : Y([e], ([t]) => u(t))
          , c = Array.isArray(e) ? void 0 : e.accelerate;
        return c && !c.isTransformed && "function" != typeof n && Array.isArray(s) && r?.clamp !== !1 && (d.accelerate = {
            ...c,
            times: n,
            keyframes: s,
            isTransformed: !0,
