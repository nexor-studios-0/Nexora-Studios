(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 43369, (e, t, r) => {
    ...
    delete document.documentElement.dataset.dplId) : n = void 0
}
, 18800, (e, t, r) => {
    "use strict";
    var n = e.r(71645);
...
, 50740, (e, t, r) => {
    ...
    function H(e, t, r) {
        ...
        return !function e(t, r, n, u, s) {
            ...
            if (d)
                ...
                c = n + (null == s.key || t && t.key === s.key ? "" : ("" + s.key).replace(k, "$&/") + "/") + d,
                s = C(a.type, c, a.props)),
                r.push(s)),
                1;
            d = 0;
            var p = "" === u ? "." : u + ":";
    ...
    r.Suspense = d,
    r.ViewTransition = h,
    r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = w,
    ...
    r.cloneElement = function(e, t, r) {
        ...
        var n = m({}, e.props)
          , o = e.key;
        if (null != t)
            for (i in void 0 !== t.key && (o = "" + t.key),
            t)
                R.call(t, i) && "key" !== i && "__self" !== i && "__source" !== i && ("ref" !== i || void 0 !== t.ref) && (n[i] = t[i]);
    ...
    r.createElement = function(e, t, r) {
        ...
        if (null != t)
            ...
            t)
                R.call(t, n) && "key" !== n && "__self" !== n && "__source" !== n && (o[n] = t[n]);
